...
title: "AWS Resource Query"
category: tools
tags: ["aws", "cloud", "query", "readonly", "infrastructure"]
version: "1.0"
---
...
The following files contain mappings of natural language intents to AWS CLI commands, organized by service category:
- [COMPUTE](references/compute.md)
- [STORAGE](references/storage.md)
- [DATABASES](references/databases.md)
- [NETWORKING](references/networking.md)
- [SECURITY & IDENTITY](references/security-identity.md)
- [MESSAGING & EVENTS](references/messaging-events.md)
- [API GATEWAY & SERVERLESS](references/api-gateway-serverless.md)
- [MONITORING & OBSERVABILITY](references/monitoring-observability.md)
- [COST & BILLING](references/cost-billing.md)
- [CROSS-SERVICE QUERIES](references/cross-service-queries.md)
